...
class __Mustache_371371d7afc7bc6625a1089022c60912 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionC91078cf0d52120e4ed079ba126072b3($context, $indent, $value);
...
';
    ...
    private function sectionC91078cf0d52120e4ed079ba126072b3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<span class="dropdown nav-item lang-menu">
';
...
';
                $buffer .= $indent . '        <i class="icon-globe"></i>
';
                $buffer .= $indent . '    </a>
';
